        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl">
              ...
              <h4 className="text-white font-bold mb-2 tracking-wide">UAE Based</h4>
              <p className="text-gray-400 text-sm font-light">Engineered in an environment that demands intelligence and efficiency.</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl">
              <Lightbulb className="text-nabtura-blue w-8 h-8 mb-4" />
              <h4 className="text-white font-bold mb-2 tracking-wide">Science & Engineering</h4>
              <p className="text-gray-400 text-sm font-light">Data-driven decisions for water, climate, and plant health.</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl sm:col-span-2">
              <Building2 className="text-nabtura-sand w-8 h-8 mb-4" />
              <h4 className="text-white font-bold mb-2 tracking-wide">INFORGRID FZC</h4>
              <p className="text-gray-400 text-sm font-light mb-6">The corporate platform supporting NABTURA's delivery, combining robust project execution with technological innovation.</p>
              <Link href="/contact" className="text-nabtura-sand hover:text-white font-bold tracking-widest text-xs uppercase flex items-center transition-colors">
