      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {possibilities.map((item, i) => (
            <div key={i} className="bg-nabtura-slate border border-white/5 rounded-3xl group hover:border-nabtura-green transition-colors relative overflow-hidden flex flex-col">
              {/* Image Container */}
