        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {possibilities.map((item, i) => (
            <Link href="/contact" key={i} className="block group">
              <div className="bg-nabtura-slate border border-white/5 rounded-3xl group-hover:border-nabtura-green transition-colors relative overflow-hidden flex flex-col h-full cursor-pointer">
                {/* Image Container */}
