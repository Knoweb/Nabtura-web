          ...
          <div className="max-w-3xl mx-auto text-center relative z-10 pb-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <div className="flex flex-col items-center gap-2">
                ...
                <Link href="/capabilities/nursery-solutions" className="inline-flex items-center justify-center bg-white/5 border border-white/10 px-5 py-2.5 rounded-xl text-gray-300 text-[10px] md:text-xs font-bold tracking-widest uppercase hover:bg-white/10 hover:border-cyan-400/30 hover:text-white transition-all group/btn">
