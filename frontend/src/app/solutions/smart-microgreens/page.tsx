  ...
  return (
    <main className="min-h-screen bg-black pt-20">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-white/10 text-center">
        ...
        <p className="text-xl md:text-2xl font-light text-gray-400 max-w-3xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {["WE BUILD. YOU GROW.", "WE BUILD. WE MANAGE.", "WE GROW. YOU HARVEST."].map((model) => (
            <div key={model} className="bg-nabtura-slate border border-white/10 p-6 rounded-2xl">
      ...
      <section className="py-24 bg-nabtura-slate border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">Why Smart Microgreen Growing?</h3>
              ...
              <h4 className="text-xl font-bold text-white mb-4">Controlled Indoor Environment</h4>
            ...
            <div className="bg-black/50 border border-white/5 p-10 rounded-3xl">
                ...
                {[
                  ...
                  return (
                    <div key={i} className="flex items-center gap-4 group">
                      <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-nabtura-green/20 transition-colors">
                        <Icon className="w-5 h-5 text-gray-400 group-hover:text-nabtura-light-green" />
                      </div>
                      <span className="text-white font-bold tracking-wide">{audience.title}</span>
                    </div>
                  );
                })}
              </div>
              ...
              <div className="mt-12 pt-8 border-t border-white/10 text-center">
                <Link href="/contact" className="group inline-flex items-center text-white bg-white/10 hover:bg-nabtura-green hover:text-black px-8 py-4 rounded-full font-bold tracking-widest text-sm uppercase transition-all">
                  Start Your Project
