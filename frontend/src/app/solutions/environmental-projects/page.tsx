    ...
    <main className="min-h-screen bg-transparent pt-20">
      ...
      <section className="py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24 max-w-4xl mx-auto">
          ...
          <p className="text-content-muted text-xl font-light leading-relaxed">
        ...
        {/* Workflow */}
        <div className="bg-nabtura-slate border border-divider rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
          {/* Decorative glow */}
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-6 group">
                <div className="w-12 h-12 rounded-full bg-overlay backdrop-blur-xl border border-divider flex items-center justify-center shrink-0 group-hover:border-nabtura-green transition-colors">
                  <span className="text-content-muted font-bold group-hover:text-nabtura-light-green">0{i+1}</span>
                </div>
                <h4 className="text-2xl md:text-3xl font-bold text-content-muted group-hover:text-content transition-colors">{step.title}</h4>
              </div>
            ))}
          </div>

          <div className="mt-20 pt-12 border-t border-divider flex justify-center">
            <Link href="/contact" className="group inline-flex items-center text-content bg-overlay hover:bg-nabtura-green hover:text-black border border-divider px-8 py-4 rounded-full font-bold tracking-widest text-sm uppercase transition-all shadow-lg">
