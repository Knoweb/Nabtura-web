        ...
        <div className="bg-gradient-to-r from-white/5 to-transparent border border-white/10 rounded-[2.5rem] p-10 md:p-16 mb-12 relative overflow-hidden group shadow-2xl">
          ...
          <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/capabilities/nursery-solutions" className="inline-flex items-center justify-center bg-white/5 border border-white/10 px-6 py-3 rounded-xl text-gray-300 text-xs font-bold tracking-widest uppercase hover:bg-white/10 hover:border-nabtura-green/30 hover:text-white transition-all group/btn">
