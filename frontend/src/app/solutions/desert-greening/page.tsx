    ...
    <main className="min-h-screen bg-black pt-20">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-white/10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-nabtura-slate p-12 rounded-[3rem] border border-white/5">
            <h3 className="text-2xl font-bold text-white mb-6">Key Applications</h3>
      ...
      <section className="py-24 bg-nabtura-slate border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Our Engineered Approach</h2>
            <p className="text-gray-400 text-xl font-light max-w-3xl mx-auto">We do not fight the environment; we engineer solutions that adapt to it.</p>
          </div>
