      ...
      <div className="py-16 md:py-16 md:pb-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <button className="bg-overlay hover:bg-nabtura-sand hover:text-black border border-divider p-8 rounded-3xl font-bold tracking-widest uppercase transition-all group flex flex-col items-center gap-4">
              <TrendingUp className="w-8 h-8 text-content-muted group-hover:text-black transition-colors" />
              I WANT TO INVEST
            </button>
            <button className="bg-overlay hover:bg-nabtura-blue hover:text-black border border-divider p-8 rounded-3xl font-bold tracking-widest uppercase transition-all group flex flex-col items-center gap-4">
