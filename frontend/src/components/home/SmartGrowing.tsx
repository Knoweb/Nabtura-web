  ...
  return (
    <section className="bg-transparent text-content py-16 md:py-12 md:py-16 border-b border-divider relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              return (
                <div key={step.id} className="flex flex-col items-center group">
                  <motion.div 
                    ...
                    className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-overlay backdrop-blur-xl border border-divider flex items-center justify-center mb-6 group-hover:border-nabtura-green group-hover:bg-overlay transition-all shadow-xl"
                  >
                    <Icon className="w-8 h-8 md:w-10 md:h-10 text-content-muted group-hover:text-nabtura-light-green transition-colors" strokeWidth={1.5} />
                  </motion.div>
        ...
        {/* Bottom Statement */}
        <div className="bg-overlay backdrop-blur-xl/50 backdrop-blur-xl border border-divider rounded-3xl p-10 md:p-16 text-center max-w-4xl mx-auto shadow-2xl">
          ...
          <p className="text-content-muted text-lg md:text-xl font-light mb-12">
