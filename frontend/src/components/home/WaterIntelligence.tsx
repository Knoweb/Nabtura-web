            ...
            <div className="space-y-12 relative z-10">
              {waterSequence.map((step, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-white/[0.03] backdrop-blur-3xl border border-white/10 flex items-center justify-center shrink-0 group-hover:border-nabtura-blue group-hover:bg-nabtura-blue/5 transition-all shadow-xl shadow-nabtura-blue/5 relative shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
