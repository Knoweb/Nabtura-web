      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-sm tracking-[0.3em] text-gray-500 font-bold mb-6 uppercase">
            {t.spaceTransformation.eyebrow}
          </h2>
          <h3 className="text-4xl md:text-6xl font-bold tracking-tight mb-8">
            {t.spaceTransformation.headline1}<br />
            <span className="text-nabtura-light-green">{t.spaceTransformation.headline2}</span>
          </h3>
          <p className="text-gray-400 text-lg md:text-xl tracking-wider font-light max-w-4xl mx-auto">
            {t.spaceTransformation.subheadline}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col gap-3">
            <h4 className="text-gray-500 text-sm tracking-[0.2em] uppercase mb-4 ml-4">{t.spaceTransformation.selectPrompt}</h4>
